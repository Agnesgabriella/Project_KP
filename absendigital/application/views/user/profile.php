                ...
                <div class="row detail">
                    ...
                    <div class="col-md-10 col-sm-8 col-6">
                        <dl class="row">
                            ...
                            <dd class="col-sm-7"><?= $shiftpegawai = ($user['bagian_shift'] == 1) ? '<span class="badge badge-success">Pagi</span>' : (($user['bagian_shift'] == 2) ? '<span class="badge badge-warning">Malam</span>'); ?></dd>
