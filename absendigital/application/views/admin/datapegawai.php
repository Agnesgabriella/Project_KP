        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <?= form_dropdown('role_pegawai', ['' => 'Select Role', 1 => 'Administrator', 2 => 'Senior Mentor', 3 => 'Mentor'], set_value('role_pegawai'), 'class="form-control" id="role_pegawai"'); ?>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <label class="form-check-label" for="shift_pegawai2">Malam</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
