        ...
        if ($dataabsen == 'datapgw') {
            ...
            foreach ($query->result() as $r) {
                $data[] = [
                    ...
                    $r->npwp,
                    $r->jenis_kelamin,
                    ($r->role_id == 1) ? '<span class="badge badge-danger ml-1">Administrator</span>' : (($r->role_id == 2) ? '<span class="badge badge-primary ml-1">Senior Mentor</span>' : (($r->role_id == 3) ? '<span class="badge badge-success ml-1">Mentor</span>' : '<span class="badge badge-secondary ml-1">Tidak Ada Role</span>')),
                    ($r->bagian_shift == 1) ? '<span class="badge badge-success ml-1">Pagi</span>' : (($r->bagian_shift == 2) ? '<span class="badge badge-warning">Malam</span>'),
