...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Okt 2021 pada 10.50
-- Versi server: 10.5.11-MariaDB
-- Versi PHP: 7.4.21
...
--
CREATE DATABASE IF NOT EXISTS `absensi_online1` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `absensi_online1`;
